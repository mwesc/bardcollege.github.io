...
var rules = {
  ...
  "~*x sorry ~*y": [
    "You'd better appologize",
    "Apologies are extremely necessary",
    "It makes me feel superior to you when you apologize",
  ],
  "~*x I remember ~*y": [
    "I don't really care about ~y?",
    "Does thinking of ~y bring anything else to mind?",
    "I am not really interested in anything else you remember?",
    "Why do you recall ~y right now?",
    "What in the present situation reminds you of ~y?",
    "What is the connection between your mom and ~y?",
  ],
  "~*x do you remember ~*y": [
    "Sorry bro I forgot ~y?",
